...
$('.btn-delete').click(function (e) {
    ...
    if (result.value) {
        ...
        var id = row.data('movimiento');  //console.log(id);
        var form = $('#form-delete'); //console.log(form.attr('action'));
        var url = form.attr('action').replace(':MOVIMIENTO_ID',id); //console.log(url);
        ...
        $.post(url, data, function (result){
            ...
            var counter = $("#movimiento_counter").text() - 1;
            
            $("#movimiento_counter").text(counter);
