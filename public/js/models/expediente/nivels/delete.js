...
$('.btn-delete').click(function (e) {
    ...
    if (result.value) {
        ...
        var id = row.data('nivel');  //console.log(id);
        var form = $('#form-delete'); //console.log(form.attr('action'));
        var url = form.attr('action').replace(':NIVEL_ID',id); //console.log(url);
        ...
        $.post(url, data, function (result){
            ...
            var counter = $("#nivel_counter").text() - 1;
            
            $("#nivel_counter").text(counter);
