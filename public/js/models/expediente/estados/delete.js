...
$('.btn-delete').click(function (e) {
    ...
    if (result.value) {
        ...
        var id = row.data('estado');  //console.log(id);
        var form = $('#form-delete'); //console.log(form.attr('action'));
        var url = form.attr('action').replace(':ESTADO_ID',id); //console.log(url);
        ...
        $.post(url, data, function (result){
            ...
            var counter = $("#estado_counter").text() - 1;

            $("#estado_counter").text(counter);
