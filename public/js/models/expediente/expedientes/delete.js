...
$('.btn-delete').click(function (e) {
    ...
    if (result.value) {
        ...
        var id = row.data('expediente');  //console.log(id);
        var form = $('#form-delete'); //console.log(form.attr('action'));
        var url = form.attr('action').replace(':EXPEDIENTE_ID',id); //console.log(url);
        ...
        $.post(url, data, function (result){
            ...
            var counter = $("#expediente_counter").text() - 1;
            
            $("#expediente_counter").text(counter);
