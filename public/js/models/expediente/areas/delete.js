...
$('.btn-delete').click(function (e) {
    ...
    if (result.value) {
        ...
        var id = row.data('area');  //console.log(id);
        var form = $('#form-delete'); //console.log(form.attr('action'));
        var url = form.attr('action').replace(':AREA_ID',id); //console.log(url);
        ...
        $.post(url, data, function (result){
            ...
            var counter = $("#area_counter").text() - 1;

            $("#area_counter").text(counter);
