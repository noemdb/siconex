...
class TaskController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('common.tasks.create',compact('user_list','tipo_list','estado_list'));
    }
    ...
    public function show($id)
    {
        ...
        return view('common.tasks.show',compact('task'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('common.tasks.edit',compact('task','user_list','tipo_list','estado_list'));
