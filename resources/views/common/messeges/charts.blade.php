          ...
          <div class="tab-pane fade show active" id="nav-tab01" role="tabpanel" aria-labelledby="nav-tab01-tab">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    @include('common.messeges.chart.messegesmonthchart')
                  
                </div>

                <div class="col-lg-6 col-md-6 col-sm-12">

                  @include('common.messeges.chart.messegesusers')                    
          ...
          <div class="tab-pane fade" id="nav-tab02" role="tabpanel" aria-labelledby="nav-tab02-tab">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  @include('common.messeges.chart.messegestypes')
                  
                </div>

                <div class="col-lg-6 col-md-6 col-sm-12">

                    {{-- @include('common.messeges.chart.rolsrangeschart') --}}
