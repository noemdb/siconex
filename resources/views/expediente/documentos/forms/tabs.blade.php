        ...
        @foreach($user->documentos as $documento)
            ...
            <div class="card">
                <div class="card-header" id="heading_task_{{ $documento->id or '' }}">
                    <h5 class="mb-0">
                        <button class="btn btn-link btn-sm" data-toggle="collapse" data-target="#accordion_task_{{ $documento->id or '' }}" aria-expanded="true" aria-conttasks="accordion_task_{{ $documento->id or '' }}">
                            {{ $documento->documento }}
                        </button>
                    </h5>
                </div>
