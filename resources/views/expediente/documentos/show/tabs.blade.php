<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-item nav-link pr-2" id="nav-documentos-tab" data-toggle="tab" href="#nav-documentos" role="tab" aria-controls="nav-documentos" aria-selected="false">documentos</a>
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
    @includeIf('expediente.documentos.show.documento')
  ...
  <div class="tab-pane fade m-1 p-1" id="nav-documentos" role="tabpanel" aria-labelledby="nav-documentos-tab">
    {{-- @isset($messeges) --}}
      {{-- @includeIf('expediente.messeges.show.messeges') --}}
    {{-- @endisset --}}
  </div>
