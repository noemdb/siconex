        ...
        @foreach($user->estados as $estado)
            ...
            <div class="card">
                <div class="card-header" id="heading_task_{{ $estado->id or '' }}">
                    <h5 class="mb-0">
                        <button class="btn btn-link btn-sm" data-toggle="collapse" data-target="#accordion_task_{{ $estado->id or '' }}" aria-expanded="true" aria-conttasks="accordion_task_{{ $estado->id or '' }}">
                            {{ $estado->estado }}
                        </button>
                    </h5>
                </div>
                ...
                <div id="accordion_task_{{ $estado->id or '' }}" class="collapse" aria-labelledby="heading_task_{{ $estado->id or '' }}" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        @include('expediente.estados.forms.update')
