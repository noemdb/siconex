...
<head>
    ...
    <link href="{{ asset('vendor/sidebar/style2.css') }}" rel="stylesheet">
            ...
            <ul class="list-unstyled components nav flex-column">
              ...
              <li class="nav-item">
                ...
                <ul class="nav flex-column">
                    ...
                    @include('expediente.layouts.dashboard.sidebar.partials.expedientes_new')
...
{{--         <nav id="sidebar">
    ...
    <script src="{{ asset('vendor/sidebar/jquery.mCustomScrollbar.concat.min.js') }}"></script>
