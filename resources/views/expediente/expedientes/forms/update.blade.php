<div class="card bd-callout bd-callout-{{ Session::get('class_oper') or "" }}">
  <div class="card-header font-weight-bold">
    Formulario para la actualización del expediente<strong>{{ $user->username or '' }}</strong>
  </div>
  <div class="card-body p-1">

      {{-- INI form --}}
      {!! Form::model($expediente,['route' => ['estudiantes.update', $expediente->id], 'method' => 'PUT', 'id'=>'form-update-task_'.$expediente->id, 'taske'=>'form']) !!}
