                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelTitle', 'N. Select Opts registrados por Mes')
                                ...
                                {{-- INI chart Tipos de selectopt registrados --}}
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelConttasks', 'true')
                                        @slot('id', $chart['id_chart'] )
                                        @slot('panelTitle', 'Tipos de Select Opts')
                                ...
                                {{-- FIN chart Tipos de selectopt registrados --}}
...
@section('scripts')
    ...
    <script>
        ...
        $('ul.ranges a').click(function(e){
            ...
            var el = $(this);
            var range = $(this).data('range'); //selectopt(range);
            var ul = $(this).parents('ul');
            var canvas = ul.data('canvas'); //selectopt(canvas);
            var api = ul.data('urlapi'); //selectopt(urlapi);
            var tipo = ul.data('tipo'); //selectopt(tipo);
            var limit = ul.data('limit'); //selectopt(limit);
