                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelTitle', 'N. Logdbs registrados por Mes')
                                ...
                                {{-- INI chart Tipos de logdb registrados --}}
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelConttasks', 'true')
                                        @slot('id', $chart['id_chart'] )
                                        @slot('panelTitle', 'Tipos de Logdbs')
                                ...
                                {{-- FIN chart Tipos de logdb registrados --}}
...
@section('scripts')
    ...
    <script>
        ...
        $('ul.ranges a').click(function(e){
            ...
            var el = $(this);
            var range = $(this).data('range'); //logdb(range);
            var ul = $(this).parents('ul');
            var canvas = ul.data('canvas'); //logdb(canvas);
            var api = ul.data('urlapi'); //logdb(urlapi);
            var tipo = ul.data('tipo'); //logdb(tipo);
            var limit = ul.data('limit'); //logdb(limit);
