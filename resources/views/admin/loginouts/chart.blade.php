                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelTitle', 'N. LogInOuts registrados por Mes')
                                ...
                                {{-- INI chart Tipos de loginout registrados --}}
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    @component('elements.widgets.panel')
                                        ...
                                        @slot('panelConttasks', 'true')
                                        @slot('id', $chart['id_chart'] )
                                        @slot('panelTitle', 'Tipos de LogInOuts')
                                ...
                                {{-- FIN chart Tipos de loginout registrados --}}
...
@section('scripts')
    ...
    <script>
        ...
        $('ul.ranges a').click(function(e){
            ...
            var el = $(this);
            var range = $(this).data('range'); //loginout(range);
            var ul = $(this).parents('ul');
            var canvas = ul.data('canvas'); //loginout(canvas);
            var api = ul.data('urlapi'); //loginout(urlapi);
            var tipo = ul.data('tipo'); //loginout(tipo);
            var limit = ul.data('limit'); //loginout(limit);
